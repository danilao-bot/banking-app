...
export default function RegisterPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Unable to register. Please check your details.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100">
      {/* Background glows */}
      <div className="glow-circle bg-purple-500 w-[45vw] h-[45vw] right-[-10vw] top-[-10vw]" />
      <div className="glow-circle bg-cyan-500 w-[40vw] h-[40vw] left-[-10vw] bottom-[-10vw]" />
          ...
          <div className="glass-panel w-full rounded-[2rem] p-10">
            ...
            <div className="mb-8 flex flex-col items-center gap-4 text-center">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-400">Register to manage customers and accounts</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="grid gap-5">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <label className="block">
                  <span className="text-xs font-semibold uppercase tracking-wider text-slate-400">First name</span>
                ...
                <label className="block">
                  <span className="text-xs font-semibold uppercase tracking-wider text-slate-400">Last name</span>
                  <div className="relative mt-2">
                    <div className="pointer-events-none absolute inset-y-0 left-4 flex items-center">
                      <svg className="h-4 w-4 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
